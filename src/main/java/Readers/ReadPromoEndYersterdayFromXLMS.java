...
import Repositories.PromoEndRepo;
 ...
 */
public class ReadPromoEndYersterdayFromXLMS {
    ...
    public static void setStartPromo(Date startPromo) {
        ReadPromoEndYersterdayFromXLMS.startPromo = startPromo;
    }
    ...
    public static void setFinishPromo(Date finishPromo) {
        ReadPromoEndYersterdayFromXLMS.finishPromo = finishPromo;
    }
    ...
    private static class SheetHandler extends DefaultHandler {
        ...
        private static void uploadPromoParts(String adressColumn, String meaning) {
            ...
            switch (adressColumn) {
                ...
                case ("H"): {
                    ...
                    PromoEndRepo.getInstance().putPromo(tarif);
                    break;
                }
            }
        }
        ...
        public void endElement(String uri, String localName, String name)
            ...
            if (name.equals("v") && !rowAdr.equals("1")) {
                uploadPromoParts(ReadPromoEndYersterdayFromXLMS.getCellAdr(), lastContents);
            }
            lastContents = "";
